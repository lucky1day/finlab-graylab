...
> 2026-08-08 后续说明：用户另行授权删除已被现行架构、SOP、正式记录、代码和测试替代的 13 份
> `docs/superpowers` 过程文档。本文件保留 2026-08-06 当时的审计结论，不再代表当前保留清单；当前状态以
> [文档中心](../../README.md)、[当前状态](../../CURRENT_STATUS.md)和[统一后续推进计划](../../TODO.md)为准。
