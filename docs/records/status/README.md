...
- [D0_DOCUMENT_LIFECYCLE_AUDIT_20260806.md](D0_DOCUMENT_LIFECYCLE_AUDIT_20260806.md)：文档保留边界，以及已按用户确认删除两份 superseded draft 的审计证据；本记录继续保留。
- [LIWEI_10Y01_T5_0811_FAILURE_DIAGNOSIS_20260806.md](LIWEI_10Y01_T5_0811_FAILURE_DIAGNOSIS_20260806.md)：D1——2026-08-11 Liwei 10Y_01 T+5 单次失败的只读控制面诊断。
...
[当前状态](../../CURRENT_STATUS.md)，调度规则查看
[生产信号与调度治理](../../architecture/PRODUCTION_SCHEDULING_GOVERNANCE.md)，后续排序和授权闸门查看
[统一后续推进计划](../../TODO.md)。
