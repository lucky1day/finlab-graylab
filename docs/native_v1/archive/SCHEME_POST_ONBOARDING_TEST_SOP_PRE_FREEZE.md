# 历史归档：SCHEME_POST_ONBOARDING_TEST_SOP.md

> 文档状态：HISTORICAL
> 适用运行时：native_adapter（冻结前历史）
> 目标读者：历史审计人员
> 最后核验日期：2026-07-19
> 原文件 SHA256：`eff6536294470f2b1bee24238c4d9e66fd6b42b620b2c95cfb79b692e4d30add`
> 当前替代文档：[../../sop/NATIVE_V1_POST_CHANGE_TEST_SOP.md](../../sop/NATIVE_V1_POST_CHANGE_TEST_SOP.md)
...
> 与 [SCHEME_ONBOARDING_SOP.md](../../sop/SCHEME_ONBOARDING_SOP.md) 的关系：入库 SOP 负责"把方案合规地改造进系统"；本 SOP 负责"验证改造后的方案结果与入库前原始方案一致，并完成落库/展示/挂载"。本 SOP 的多个失败分支会**打回入库 SOP**。
>
...
> 打回 `REJECTED_TO_ONBOARDING` 的方案，必须由 [SCHEME_ONBOARDING_SOP.md](../../sop/SCHEME_ONBOARDING_SOP.md) 流程排查根因并改造，改造完成后**从 S1 重新开始**整个验证。
...
| **REJECTED_TO_ONBOARDING** | S1/S2/S4/S5 失败 | 打回 [SCHEME_ONBOARDING_SOP.md](../../sop/SCHEME_ONBOARDING_SOP.md)，排查根因→改造→**从 S1 重来** |
