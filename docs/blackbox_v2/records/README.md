...
- [GRAY_ONBOARDING_10Y_T5_4SCHEMES_20260726.md](GRAY_ONBOARDING_10Y_T5_4SCHEMES_20260726.md)：2026-07-26 四个 10Y T+5 方案的 exact active、历史入库验收与同日 generation 等待边界。
