...
function element(id) {
  ...
  const value = {
    ...
    matches(selector) { return selector === ":popover-open" && value.open; },
    showPopover() { value.open = true; },
    hidePopover() { value.open = false; },
    setCustomValidity(message) { value.validationMessage = message; },
    reportValidity() { return !value.validationMessage; },
    focus() {},
    reset() {},
