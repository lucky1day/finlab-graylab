...
- 当前 canonical CSV 截至 `2026-05-28`；T1/T5 逐方案 benchmark 为覆盖完整 2026-05 目标月，会经 `shared.input_artifacts` 从 DB 补齐 `2026-05-29` 目标验证日。该补齐只用于 label/actual，不改变 source T / `feature_date` 站位。
