...
SCHEME = {'target_tenor': '7Y', 'close_col': 'TB7YWI0C', 'aux_pairs': (('3Y', 'TB3YWI0C'), ('5Y', 'TB5YWI0C'), ('10Y', 'TB0YWI0C')), 'model_family': 'xgb', 'signal': '7Y_rv_rev20', 'screen_metric': 'sharpe', 'screen_window': 756, 'top_self': 30, 'top_mf': 30, 'train_window': 756, 'n_estimators': 100, 'learning_rate': 0.03, 'max_depth': 1, 'min_child_weight': 10.0, 'reg_alpha': 0.5, 'reg_lambda': 4.0, 'colsample_bytree': 0.8, 'tree_weight': 0.75, 'margin': 0.1, 'balance_trigger': 0}
