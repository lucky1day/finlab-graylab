...
CACHE_FAMILY = "liwei_0616_5y_allk10_auc_static_v1"
CACHE_CONSUMER_ID = "liwei_0616_5y_auc_static_all_k3_div_k10"
CACHE_PUBLISHER_CONSUMER_ID = CACHE_CONSUMER_ID
MODEL_VERSION = "liwei_5y_allk10_auc_static_v1"
...
def run_for_feature_date(
    *,
    ...
    """运行 5Y AUC static ALL_K10 live-safe Full-OOS 并选择精确站位日。"""
    ...
    if matched.empty:
        raise RuntimeError(
            "liwei_0616 5Y AUC static ALL_K10 produced no row "
