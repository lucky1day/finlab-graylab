...
from .core.v31_common import MODEL_VERSION, run_5y01_for_feature_window
...
def run_5y01_for_feature_date(
    *,
    ...
    """按单个 feature_date 的 PIT 窗口运行 5Y_01，并返回该日明细。"""
...
def run_5y01_for_window_silent(**kwargs: Any) -> pd.DataFrame:
