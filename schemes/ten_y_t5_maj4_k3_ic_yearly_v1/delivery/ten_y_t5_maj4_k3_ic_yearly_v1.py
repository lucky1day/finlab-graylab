...
SCHEME_ID = 'ten_y_t5_maj4_k3_ic_yearly_v1'
if Path(__file__).stem != SCHEME_ID:
    raise RuntimeError("script filename must equal the fixed scheme_id")
CONFIG = {'members': ('curve_momentum_5', 'ten_y_reversion_20', 'market_breadth_10', 'risk_switch_20'), 'lgbm': {'window': 252, 'n_estimators': 100, 'learning_rate': 0.025, 'num_leaves': 7, 'min_child_samples': 25, 'reg_alpha': 1.5, 'reg_lambda': 1.5, 'colsample_bytree': 0.8}}
