...
SCHEME_CONFIG: dict[str, Any] = {'scheme_id': 'weekly_5y_full_action_lowcorr02_v3',
 'target': 'TB5YWI0C',
 'weekly_target': 'TB5YWI3C',
 'quorum': 1,
 'daily_columns': ['TB0YWI0C', 'TB1YWI0C', 'TB3YWI0C', 'TB5YWI0C', 'TB7YWI0C'],
 'weekly_columns': ['TB5YWI3C'],
 'members': [{'config_id': 'extra_trees_0047',
              'family': 'extra_trees',
              'train_window': 104,
             ...
             {'config_id': 'knn_0137',
              'family': 'knn',
              'train_window': 416,
              'params': {'n_neighbors': 5, 'weights': 'uniform', 'p': 1},
              'reject': 0.0,
              'features': ['core::vol4',
                           'core::vol3',
                           'core::spread_TB0YWI0C_TB5YWI0C',
