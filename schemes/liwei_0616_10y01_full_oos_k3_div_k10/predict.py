...
from .core.v31_common import PROD_CONFIG, SOURCE_MODEL_ID

from .inference import MODEL_VERSION, full_oos_window, run_for_feature_date
...
def run(predict_date: str) -> list[PredictionRecord]:
    """执行 liwei_0616 10Y_01 日频 T+5 实盘预测。"""
