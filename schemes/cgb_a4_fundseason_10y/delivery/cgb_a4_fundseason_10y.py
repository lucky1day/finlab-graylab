#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""cgb_a4_fundseason_10y —— 10Y 国债月频方向算法方案 (Blackbox V2 / Contract 1.0)。

单文件交付物。两个命令复用完全相同的数据处理、算法逻辑与方向映射:

    python cgb_a4_fundseason_10y.py predict  --request  request.json  \
        --data-dir <data-dir> --output prediction.json
    python cgb_a4_fundseason_10y.py backtest --requests requests.csv  \
...
SCHEME_ID = "cgb_a4_fundseason_10y"
