...
SCHEME = {'target_tenor': '5Y', 'close_col': 'TB5YWI0C', 'aux_pairs': (('1Y', 'TB1YWI0C'), ('3Y', 'TB3YWI0C'), ('7Y', 'TB7YWI0C')), 'model_family': 'lgbm', 'signal': '3Y_anti_lag252', 'screen_metric': 'sharpe', 'screen_window': 756, 'top_self': 30, 'top_mf': 30, 'train_window': 504, 'n_estimators': 140, 'learning_rate': 0.02, 'num_leaves': 15, 'max_depth': 4, 'min_child_samples': 40, 'reg_alpha': 1.0, 'reg_lambda': 3.0, 'colsample_bytree': 0.75, 'tree_weight': 0.75, 'margin': 0.05, 'balance_trigger': 8}
