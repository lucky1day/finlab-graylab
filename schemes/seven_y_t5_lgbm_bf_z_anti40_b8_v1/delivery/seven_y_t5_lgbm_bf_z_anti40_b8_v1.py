...
SCHEME = {'target_tenor': '7Y', 'close_col': 'TB7YWI0C', 'aux_pairs': (('3Y', 'TB3YWI0C'), ('5Y', 'TB5YWI0C'), ('10Y', 'TB0YWI0C')), 'model_family': 'lgbm', 'signal': 'bf_z_anti40', 'screen_metric': 'sharpe', 'screen_window': 756, 'top_self': 30, 'top_mf': 30, 'train_window': 756, 'n_estimators': 140, 'learning_rate': 0.02, 'num_leaves': 15, 'max_depth': 4, 'min_child_samples': 40, 'reg_alpha': 1.0, 'reg_lambda': 3.0, 'colsample_bytree': 0.75, 'tree_weight': 0.75, 'margin': 0.1, 'balance_trigger': 8}
