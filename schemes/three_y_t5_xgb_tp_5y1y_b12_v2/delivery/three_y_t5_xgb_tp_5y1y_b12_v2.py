...
SCHEME = {'model_family': 'xgb', 'signal': 'tp_5Y1Y_z_anti20', 'screen_metric': 'sharpe', 'screen_window': 756, 'top_self': 30, 'top_mf': 30, 'train_window': 504, 'n_estimators': 120, 'learning_rate': 0.025, 'max_depth': 2, 'min_child_weight': 20.0, 'reg_alpha': 1.0, 'reg_lambda': 5.0, 'colsample_bytree': 0.75, 'tree_weight': 0.75, 'margin': 0.1, 'balance_trigger': 12, 'target_tenor': '3Y', 'close_col': 'TB3YWI0C', 'aux_pairs': (('1Y', 'TB1YWI0C'), ('5Y', 'TB5YWI0C'), ('7Y', 'TB7YWI0C'))}
