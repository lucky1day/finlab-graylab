...
CACHE_FAMILY = "liwei_0616_5y_allk10_auc_yearly_v1"
CACHE_CONSUMER_ID = "liwei_0616_5y_auc_yearly_all_k3_div_k10"
MODEL_VERSION = "liwei_5y_allk10_auc_yearly_v1"
...
def run_for_feature_date(
    *,
    ...
    """运行 5Y AUC yearly ALL_K10 live-safe Full-OOS 并选择精确站位日。"""
    ...
    if matched.empty:
        raise RuntimeError(
            "liwei_0616 5Y AUC yearly ALL_K10 produced no row "
