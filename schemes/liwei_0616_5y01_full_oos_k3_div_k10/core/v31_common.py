#!/usr/bin/env python3
"""bond_common.py -- V28 shared module for bond yield prediction.
...
def run_5y01_for_feature_window(
    *,
    ...
    current_mask = (ref["anchor_date"].astype(str) >= current_start) & (ref["anchor_date"].astype(str) <= current_end)
