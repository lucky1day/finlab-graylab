...
TARGET_COL = "TB0YWI3C"
REQUIRED_CURRENT_COLUMNS = [TARGET_COL, "TB1YWI3C", "TB5YWI3C"]
LOOKBACK_WEEKS = 600
FUTURE_LOAD_WEEKS = 6
...
def run(predict_date: str) -> list[PredictionRecord]:
    ...
    try:
        ...
        raw_weekly_df = input_artifact.dataframe
        if raw_weekly_df.empty:
        ...
        weekly_df = _attach_db_week_dates(raw_weekly_df, calendar)
