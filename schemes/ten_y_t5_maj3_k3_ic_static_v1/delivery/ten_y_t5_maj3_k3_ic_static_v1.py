...
SCHEME_ID = 'ten_y_t5_maj3_k3_ic_static_v1'
if Path(__file__).stem != SCHEME_ID:
    raise RuntimeError("script filename must equal the fixed scheme_id")
CONFIG = {'members': ('curve_momentum_5', 'ten_y_reversion_20', 'market_breadth_10'), 'lgbm': {'window': 252, 'n_estimators': 80, 'learning_rate': 0.03, 'num_leaves': 7, 'min_child_samples': 25, 'reg_alpha': 1.0, 'reg_lambda': 1.0, 'colsample_bytree': 0.8}}
