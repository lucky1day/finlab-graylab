...
SCHEME = {'model_family': 'lgbm', 'signal': '7Y_anti_sum60', 'screen_metric': 'auc', 'screen_window': 504, 'top_self': 30, 'top_mf': 30, 'train_window': 756, 'n_estimators': 180, 'learning_rate': 0.025, 'num_leaves': 7, 'min_child_samples': 30, 'reg_alpha': 1.0, 'reg_lambda': 3.0, 'colsample_bytree': 0.75, 'tree_weight': 0.75, 'margin': 0.05, 'balance_trigger': 12, 'target_tenor': '3Y', 'close_col': 'TB3YWI0C', 'aux_pairs': (('1Y', 'TB1YWI0C'), ('5Y', 'TB5YWI0C'), ('7Y', 'TB7YWI0C'))}
