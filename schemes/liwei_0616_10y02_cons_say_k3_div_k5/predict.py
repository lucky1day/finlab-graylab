...
from .inference import liwei_0616_pit_window, run_10y02_for_feature_date
...
def run(predict_date: str) -> list[PredictionRecord]:
    """执行 liwei_0616 10Y_02 日频 T+5 实盘预测。"""
    ...
    try:
        ...
        result = run_10y02_for_feature_date(
...
def _record_extra(
    *,
    ...
    return {
        ...
        "model_scope": "liwei_0616_10y02_source_compatible_context",
