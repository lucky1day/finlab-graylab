...
def build_all_signals(df, col_map: dict | None = None,
    ...
    spread_pairs = [
        ("3Y", "1Y"), ("5Y", "1Y"), ("5Y", "3Y"), ("10Y", "3Y"),
        ("10Y", "5Y"), ("10Y", "5Y"), ("10Y", "10Y"), ("10Y", "1Y"),
        ("10Y", "3Y"),
    ]
    ...
    for tnr, left, right in [("5Y", "3Y", "10Y"), ("10Y", "5Y", "10Y"),
                              ("3Y", "1Y", "5Y")]:
    ...
    for ln, rn in [("10Y", "1Y"), ("10Y", "3Y"), ("5Y", "1Y"), ("10Y", "1Y"),
                   ("3Y", "1Y"), ("10Y", "3Y"), ("5Y", "3Y")]:
    ...
    for leader, follower in [
        ("1Y", "3Y"), ("1Y", "5Y"), ("1Y", "10Y"), ("1Y", "10Y"),
        ("3Y", "5Y"), ("3Y", "10Y"), ("3Y", "10Y"),
        ("5Y", "10Y"), ("5Y", "10Y"), ("10Y", "10Y"),
    ]:
        for lag in [1, 2, 3, 5]:
    ...
    for tn, er in [
        ...
        ("5Y", rets["5Y"] - 0.5 * (rets["3Y"] + rets["10Y"])),
        ("10Y", rets["10Y"] - 0.5 * (rets["5Y"] + rets["10Y"])),
        ("10Y", rets["10Y"] - rets["10Y"]),
    ]:
