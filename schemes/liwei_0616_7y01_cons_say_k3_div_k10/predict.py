...
from .inference import liwei_0616_pit_window, run_7y01_for_feature_date
...
def run(predict_date: str) -> list[PredictionRecord]:
    """执行 liwei_0616 7Y_01 日频 T+5 实盘预测。"""
    ...
    try:
        ...
        result = run_7y01_for_feature_date(
...
def _record_extra(
    *,
    ...
    return {
        ...
        "model_scope": "liwei_0616_7y01_source_compatible_context",
