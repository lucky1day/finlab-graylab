...
SCHEME_CONFIG: dict[str, Any] = {'scheme_id': 'weekly_3y_full_action_rule0001_v2',
 'target': 'TB3YWI0C',
 'weekly_target': 'TB3YWI3C',
 'quorum': 1,
 'daily_columns': ['TB0YWI0C', 'TB1YWI0C', 'TB3YWI0C', 'TB5YWI0C', 'TB7YWI0C'],
 'weekly_columns': ['TB3YWI3C'],
 'members': [{'config_id': 'rule_0001',
              'family': 'rule',
              'train_window': 208,
              'params': {'rank': 1},
              'reject': 0.0,
              'features': ['core::spread_TB5YWI0C_TB3YWI0C', 'core::spread_TB7YWI0C_TB3YWI0C']}]}
REQUEST_FIELDS = (
