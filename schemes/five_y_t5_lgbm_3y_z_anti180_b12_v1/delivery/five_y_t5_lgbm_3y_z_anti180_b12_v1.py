...
SCHEME = {'target_tenor': '5Y', 'close_col': 'TB5YWI0C', 'aux_pairs': (('1Y', 'TB1YWI0C'), ('3Y', 'TB3YWI0C'), ('7Y', 'TB7YWI0C')), 'model_family': 'lgbm', 'signal': '3Y_z_anti180', 'screen_metric': 'ic', 'screen_window': 504, 'top_self': 30, 'top_mf': 30, 'train_window': 756, 'n_estimators': 100, 'learning_rate': 0.03, 'num_leaves': 7, 'max_depth': 3, 'min_child_samples': 30, 'reg_alpha': 0.5, 'reg_lambda': 2.0, 'colsample_bytree': 0.8, 'tree_weight': 0.75, 'margin': 0.1, 'balance_trigger': 12}
