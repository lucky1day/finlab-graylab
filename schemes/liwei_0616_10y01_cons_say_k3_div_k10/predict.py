...
from .inference import liwei_0616_pit_window, run_10y01_for_feature_date
...
def run(predict_date: str) -> list[PredictionRecord]:
    ...
    try:
        ...
        result = run_10y01_for_feature_date(
...
def _record_extra(
    *,
    ...
    return {
        ...
        "model_scope": "liwei_0616_10y01_source_compatible_context",
