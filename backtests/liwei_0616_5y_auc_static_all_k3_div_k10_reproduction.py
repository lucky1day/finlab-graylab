...
from schemes.liwei_0616_5y_auc_static_all_k3_div_k10.core.v31_common import (
    PROD_CONFIG,
    SCREEN_METRIC,
    SCREEN_REBAL,
    SOURCE_MODEL_ID,
...
from schemes.liwei_0616_5y_auc_static_all_k3_div_k10.inference import (
    CACHE_FAMILY,
    MODEL_VERSION,
    full_oos_window,
...
SCHEME_ID = "liwei_0616_5y_auc_static_all_k3_div_k10"
BENCHMARK_ID = "liwei_0616_5y_auc_static_all_k3_div_k10"
DATA_SOURCE = common.DATA_SOURCE
TARGET_TENOR = common.TARGET_TENOR
HORIZON = common.HORIZON
BACKTEST_INPUT_START = common.BACKTEST_INPUT_START
BACKTEST_INPUT_END = common.BACKTEST_INPUT_END
BACKTEST_START = common.BACKTEST_START
BACKTEST_END = common.BACKTEST_END
BACKTEST_PREDICT_START_DATE = common.BACKTEST_PREDICT_START_DATE
LIVE_TARGET_CUTOFF = common.LIVE_TARGET_CUTOFF
...
def run_liwei_0616_5y_auc_static_all_k3_div_k10_reproduction(
    *,
    persist: bool = True,
    ...
    """执行 5Y AUC static ALL_K10 DB-aligned 历史回测。"""
...
def main() -> None:
    ...
    result = run_liwei_0616_5y_auc_static_all_k3_div_k10_reproduction(
