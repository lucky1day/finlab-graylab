...
from schemes.liwei_0616_7y01_cons_say_k3_div_k10.core.v31_common import MODEL_VERSION, SOURCE_MODEL_ID
...
def run_historical_prediction(
    *,
    ...
    for feature_date in _historical_feature_dates(daily_df):
...
def _historical_feature_dates(daily_df: pd.DataFrame) -> list[str]:
