...
from schemes.liwei_0616_5y_ic_yearly_all_k3_div_k10.core.v31_common import (
    PROD_CONFIG,
    SCREEN_METRIC,
    SCREEN_REBAL,
    SOURCE_MODEL_ID,
...
from schemes.liwei_0616_5y_ic_yearly_all_k3_div_k10.inference import (
    CACHE_FAMILY,
    MODEL_VERSION,
    full_oos_window,
...
SCHEME_ID = "liwei_0616_5y_ic_yearly_all_k3_div_k10"
...
def run_liwei_0616_5y_ic_yearly_all_k3_div_k10_reproduction(
    *,
    persist: bool = True,
    ...
    """执行 5Y IC yearly ALL_K10 DB-aligned 历史回测。"""
...
def main() -> None:
    ...
    result = run_liwei_0616_5y_ic_yearly_all_k3_div_k10_reproduction(
