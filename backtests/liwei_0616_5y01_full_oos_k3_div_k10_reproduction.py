...
from schemes.liwei_0616_5y01_full_oos_k3_div_k10.core.v31_common import (
    PROD_CONFIG,
    SOURCE_MODEL_ID,
    model_config,
    run_prediction,
)
from schemes.liwei_0616_5y01_full_oos_k3_div_k10.inference import (
    MODEL_VERSION,
...
def required_baselines() -> list[str]:
    return [str(name) for name in PROD_CONFIG["baselines"]]
...
def run_liwei_0616_5y01_full_oos_k3_div_k10_reproduction(
    *,
    persist: bool = True,
    n_workers: int = DEFAULT_N_WORKERS,
...
def main() -> None:
    ...
    result = run_liwei_0616_5y01_full_oos_k3_div_k10_reproduction(
