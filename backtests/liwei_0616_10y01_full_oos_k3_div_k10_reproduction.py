...
from schemes.liwei_0616_10y01_full_oos_k3_div_k10.core.v31_common import (
    PROD_CONFIG,
    SOURCE_MODEL_ID,
    model_config,
    required_baselines,
...
from schemes.liwei_0616_10y01_full_oos_k3_div_k10.inference import (
    MODEL_VERSION,
...
def run_liwei_0616_10y01_full_oos_k3_div_k10_reproduction(
    *,
    persist: bool = True,
    n_workers: int = DEFAULT_N_WORKERS,
...
def main() -> None:
    ...
    result = run_liwei_0616_10y01_full_oos_k3_div_k10_reproduction(
